...
def creat_road_6node():
    add_road(1,     1,      3,      40,     3000*2, 40.0)
    add_road(2,     1,      5,      20,     2000*2, 15.0)
    add_road(3,     2,      5,      20,     2000*2, 15.0)
    add_road(4,     2,      4,      60,     4000*2, 50.0)
    add_road(5,     5,      6,      20,     3000*2, 20.0)
    add_road(6,     6,      3,      20,     2000*2, 20.0)
    add_road(7,     6,      4,      20,     2000*2, 20.0)
                                                
    add_road(-1,    3,      1,      40,     3000*2, 40.0)
    add_road(-2,    5,      1,      20,     2000*2, 15.0)
    add_road(-3,    5,      2,      20,     2000*2, 15.0)
    add_road(-4,    4,      2,      60,     4000*2, 50.0)
    add_road(-5,    6,      5,      20,     3000*2, 20.0)
    add_road(-6,    3,      6,      20,     2000*2, 20.0)
    add_road(-7,    4,      6,      20,     2000*2, 20.0)
